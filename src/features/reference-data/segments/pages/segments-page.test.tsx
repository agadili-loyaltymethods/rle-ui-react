  ...
  ServerTablePage: Object.assign(
    (props: Record<string, unknown>) => (
      <div data-testid="server-table-page">
        <h1>{(props.config as { pageTitle?: string })?.pageTitle ?? "Segments"}</h1>
      </div>
    ),
    {
...
describe("SegmentsPage", () => {
  ...
  it("exports a default component", () => {
    expect(typeof SegmentsPage).toBe("function");
  });

  it("renders the server table page", () => {
    render(<SegmentsPage />, { routerEntries: ["/reference-data/segments"] });
